...
function Shape() {
  ...
  this.metadata = function () {
    this.metavol = floor(map((split(metadata[4+this.selection*6],":")[1]), 0, 100, 0, 500));
    this.metapan = floor(map((split(metadata[5+this.selection*6],":")[1]), -50, 50, 20, windowWidth-20));
    this.metafreq = float((split(metadata[6+this.selection*6],":")[1]));
    // center xy
