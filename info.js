...
var infoData = [
  ...
  },
  {
    ...
    "solo": "La tecla 'S' soleará (dejará sonando de forma única) o des-soleará el instrumento seleccionado. Cuando un instrumento esta 'soleado', los demás instrumentos siguen reproduciéndose, pero 'muteados'.",
...
function information() {
  ...
  for (var i = 0; i < track.length; i++) {
    if (mouseX >= windowWidth/2-350+(i*50)+xpos-20 &&
      ...
      rect(mouseX+10, mouseY+50, 80, 20, 0, 0, 5, 5);
      fill(200, 100, 0);
      text(split(metadata[9-(lenguage)+(i*6)],":")[1], mouseX+10, mouseY+30);
      fill(0, 100,200);
      text(infoData[lenguage].version + ": " + raTr[i], mouseX+10, mouseY+50);
      fill(200, 100, 0);
    }
  }
